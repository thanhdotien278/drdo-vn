...
export function EmployeeOrderDetailPage() {
  ...
  const order = useAsync<StaffOrderDetail>(
    async () => (await fetchEmployeeOrder(orderNo)).data,
    [orderNo],
  );
                ...
                {actions.map((action) => (
                  <button
                    ...
                    onClick={() => {
                      ...
                      void runAction(() =>
                        updateEmployeeOrderStatus(data.orderNo, action.status, note.trim()),
                      );
                    }}
                  >
                    {action.label}
          ...
          <section className="checkout-panel" aria-labelledby="payment-heading">
            ...
            <button
              ...
              onClick={() => {
                ...
                void runAction(() =>
                  updateEmployeeOrderPayment(data.orderNo, nextPayment, note.trim()),
                );
              }}
            >
